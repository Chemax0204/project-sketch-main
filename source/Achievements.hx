...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [
		["Funkin on a Friday night? God you're pathetic",	"FC Funky Hill Zone",	'funky_fc',	 false],
		["Knuckles & Sonic",	"FC Knucks",	'knucks_fc',	 false]
	];
...
class AttachedAchievement extends FlxSprite {
	...
	public function reloadAchievementImage() {
		if(Achievements.isAchievementUnlocked(tag)) {
			loadGraphic(Paths.image('newAchievements'), true, 150, 150);
